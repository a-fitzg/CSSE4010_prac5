...
HD_PWD='C:/Users/s4533087/CSSE4010/prac5/CSSE4010_prac5/netlist/hdl_netlist/fir_optimised.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_optimised.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_optimised.tcl
